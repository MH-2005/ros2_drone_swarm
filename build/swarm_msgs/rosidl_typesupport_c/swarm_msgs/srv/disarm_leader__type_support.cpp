...
static const _DisarmLeader_Request_type_support_symbol_names_t _DisarmLeader_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarm_msgs, srv, DisarmLeader_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swarm_msgs, srv, DisarmLeader_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, swarm_msgs, srv, DisarmLeader_Request)() {
  return &::swarm_msgs::srv::rosidl_typesupport_c::DisarmLeader_Request_message_type_support_handle;
}
...
static const _DisarmLeader_Response_type_support_symbol_names_t _DisarmLeader_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarm_msgs, srv, DisarmLeader_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swarm_msgs, srv, DisarmLeader_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, swarm_msgs, srv, DisarmLeader_Response)() {
  return &::swarm_msgs::srv::rosidl_typesupport_c::DisarmLeader_Response_message_type_support_handle;
}
...
static const _DisarmLeader_Event_type_support_symbol_names_t _DisarmLeader_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarm_msgs, srv, DisarmLeader_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swarm_msgs, srv, DisarmLeader_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, swarm_msgs, srv, DisarmLeader_Event)() {
  return &::swarm_msgs::srv::rosidl_typesupport_c::DisarmLeader_Event_message_type_support_handle;
}
...
static const _DisarmLeader_type_support_symbol_names_t _DisarmLeader_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarm_msgs, srv, DisarmLeader)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swarm_msgs, srv, DisarmLeader)),
  }
};
...
static const rosidl_service_type_support_t DisarmLeader_service_type_support_handle = {
  ...
  &DisarmLeader_Request_message_type_support_handle,
  &DisarmLeader_Response_message_type_support_handle,
  &DisarmLeader_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, swarm_msgs, srv, DisarmLeader)() {
  return &::swarm_msgs::srv::rosidl_typesupport_c::DisarmLeader_service_type_support_handle;
}
